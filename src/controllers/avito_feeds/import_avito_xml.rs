...
pub async fn import_avito_xml(
        ...
        .build()
    {
        ...
        Err(e) => {
            ...
            return Ok(actix_web::HttpResponse::InternalServerError().json(serde_json::json!({
                "status": "error",
    ...
    let avito_feed_result: Result<AvitoFeed, diesel::result::Error> = diesel::insert_into(crate::schema::avito_feeds::table)
        .values(new_feed)
        .get_result(&mut conn);
