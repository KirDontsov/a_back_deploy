use crate::{models::{AvitoAccount, AvitoAccountResponse, AvitoAccountData}, AppState};
        ...
        .first::<AvitoAccount>(&mut conn)
    {
        Ok(avito_account) => {
            ...
            match crate::utils::encryption::decrypt_avito_credentials(&avito_account.avito_client_secret, &avito_account.avito_client_id) {
                ...
                Err(e) => {
                    eprintln!("Failed to decrypt credentials for account {}: {}", avito_account.account_id, e);
